  ...
  try {
    const response = await fetch("https://api.anthropic.com/v1/messages", {
      ...
      body: JSON.stringify({
        ...
        max_tokens: 1000,
        system: "You are a fitness coach assistant. Never reference calorie intake or calories burned. Always respond with strictly valid JSON only, no markdown fences, no preamble.",
        messages: [{
          role: "user",
          content: [{
            type: "text",
